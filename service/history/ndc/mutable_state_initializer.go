...
func (r *MutableStateInitializerImpl) flushBufferEvents(
	...
	if err != nil {
		log.ErrorWithCode(r.logger, errorcode.HistReplicationTaskExecutorOperationFailed, "MutableStateMapping::FlushBufferEvents unable to flush buffer events", err)
		return nil, err
	}
