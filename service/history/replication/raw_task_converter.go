...
func convertGetHistoryError(
	...
	case *serviceerror.NotFound:
		...
		log.ErrorWithCode(logger, errorcode.HistReplicationTaskConversionFailed, "Cannot get history from missing workflow", err,
	...
	case *serviceerror.DataLoss:
		// bypass this corrupted workflow to unblock the replication queue.
		log.ErrorWithCode(logger, errorcode.HistReplicationTaskConversionFailed, "Cannot get history from corrupted workflow", err,
			tag.WorkflowNamespaceID(workflowKey.NamespaceID),
			tag.WorkflowID(workflowKey.WorkflowID),
			tag.WorkflowRunID(workflowKey.RunID))
		return nil
